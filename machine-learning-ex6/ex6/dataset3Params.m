...
valores_prueba = [0.01 0.03 0.1 0.3 1 3 10 30];
error_min = inf;

fprintf('chill hommie i am looking for C and sigma, yo values\n');
for C = valores_prueba
  for sigma = valores_prueba
    fprintf('.');
...
fprintf('global min found C, sigma = %f, %f with error = %f', C_final, sigma_final, error_min)
